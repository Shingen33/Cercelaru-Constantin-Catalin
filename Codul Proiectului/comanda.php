...
if(isset($_POST['order'])){
   ...
   mysqli_query($conn, "INSERT INTO `orders`(user_id, name, number, email, method, address, total_products, total_price) VALUES('$user_id', '$name', '$email', '$method', '$address', '$total_products', '$total_price')");
